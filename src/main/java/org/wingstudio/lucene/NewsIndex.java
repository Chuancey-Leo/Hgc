...
public class NewsIndex
{
  ...
  private IndexWriter getWriter()
    throws Exception
  {
    this.dir = FSDirectory.open(Paths.get("C:\\hgc\\index\\news", new String[0]));
    ...
    throws Exception
  {
    ...
    doc.add(new StringField("clickHit", String.valueOf(news.getClickHit()), Field.Store.YES));
  ...
  public List<News> searchNews(String q) throws Exception
  {
    ...
    for (ScoreDoc scoreDoc : hits.scoreDocs) {
      ...
      news.setClickHit(Integer.valueOf(Integer.parseInt(doc.get("clickHit"))));
