    ...
    <div class="row">
        <div class="col-md-3 depart-left-nav">
            ...
            <ul class="nav nav-pills nav-stacked"role="tablist">
                <li class="active"><a href="${pageContext.request.contextPath}/part/introduce">介绍</a></li>
            ...
            <article class="department-info">
                <h2><span>部门简介</span>
                    <nav class="leader-route">
                        ...
                        <a href="${pageContext.request.contextPath}/part/introduce" class="route-item">部门简介</a>&nbsp;
                    </nav>
                </h2>
                <p class="depart-text">
                    ${part.content}
