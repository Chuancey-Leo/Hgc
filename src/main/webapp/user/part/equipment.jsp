    ...
    <div class="row">
        <div class="col-md-3 depart-left-nav">
            ...
            <ul class="nav nav-pills nav-stacked"role="tablist">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/part/equipment">设备科</a></li>
            ...
            <article class="department-info">
                <h2><span>设备科</span>
                    <nav class="leader-route">
                        ...
                        <a href="${pageContext.request.contextPath}/part/equipment" class="route-item">设备科</a>&nbsp;
                    </nav>
                </h2>
                <p class="depart-text">
                    ${part.content}
