    ...
    <div class="row">
        <div class="col-md-3 depart-left-nav">
            ...
            <ul class="nav nav-pills nav-stacked"role="tablist">
                <li class="active"><a href="${pageContext.request.contextPath}/file/policy">政策法规</a></li>
        ...
        <div class="col-md-9 col-xs-12">
            <div class="list-wrap files-list-wrap">
                <h3><i class="fa fa-list-alt"></i> 政策法规
                    
                </h3>
                <div class="list-box">
                    <ul class="newslist">
                        <c:forEach var="policy" items="${policyList}">
                            <li><a href="${pageContext.request.contextPath}/file/preview/${policy.id}"><i class="fa fa-chevron-circle-right"></i> &nbsp;&nbsp;&nbsp; <c:out value="${policy.title}" escapeXml="true"/></a>
                                <span><i class="fa fa-calendar"></i> <fmt:formatDate value="${policy.releaseDate }" type="date" pattern="MM-dd"/></span></li>
                        </c:forEach>
                    </ul>
                    <nav>
                        <ul class="pagination">
