	...
	<script type="text/javascript">
		...
		function deleteLink(){
			...
			$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/user/admin/deleteLink",{ids:ids},function(result){
						if(result.success){
							if(result.exist){
		...
		function openLinkModifyDialog(){
			...
			$("#fm").form("load",row);
			url="${pageContext.request.contextPath}/user/admin/updateLink?id=" +row.id;
		}
...
<table id="dg" title="博客类别管理" class="easyui-datagrid"
	   ...
	   url="${pageContext.request.contextPath}/user/admin/listLink" fit="true" toolbar="#tb">
	<thead>
	<tr>
