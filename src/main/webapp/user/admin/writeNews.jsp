...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.post("${pageContext.request.contextPath}/user/admin/saveNews",{'title':title,'newsTypeId':newsTypeId,'content':content,'contentNoTag':UE.getEditor('editor').getContentTxt(),'keyWords':keyWord},function(result){
				if(result.success){
					alert("新闻发布成功！");
					resetValue();
				}else{
