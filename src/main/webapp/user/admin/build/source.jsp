...
<div class="main-wrap container">
    ...
    <div class="main-left col-sm-12 col-xs-12 col-md-4 col-lg-3">
        <div class="list-group">
            ...
            <a href="${pageContext.request.contextPath}/user/admin/addSource" class="list-group-item active">
    ...
    <div class="main-right col-sm-12 col-xs-12 col-md-8 col-lg-9">
        <form id= "uploadForm">
           ...
           <%-- <p >选择文件： <input type="file" id="file" name="file" onchange="fileChange(this)"/></p>--%>
            ...
            <select id="sourceTypeId" name="sourceTypeId" editable="false" panelHeight="auto" style="background-color: #FFFFFF;border-radius: 3px;">
...
<script type="text/javascript">
    function uploadFile() {
        ...
        // 接收上传文件的后台地址
        var FileController = "${pageContext.request.contextPath}/user/admin/uploadSource";
        // FormData 对象
	...
	btn.button('loading');
                    $.ajax({
                        url:"${pageContext.request.contextPath}/user/admin/uploadSource",
                        type:"POST",
                        data:form,
                        contentType:false,
                        processData:false,
