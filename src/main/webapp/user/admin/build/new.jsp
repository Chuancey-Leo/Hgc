...
<head>
    ...
    <script type="text/javascript">
        function submitData(){
		    ...
		    var btn = $("#submitBtn");
                        btn.button('loading');
                        $.post("${pageContext.request.contextPath}/user/admin/saveNews",{'title':title,'author':author,'newsTypeId':newsTypeId,'content':content,'contentNoTag':contentNoTag},function(result){
                                if(result.success){
                                    swal({
                                                title:"发布成功！",
                                                text:"",
...
<div class="main-wrap container">
    ...
    <div class="main-left col-sm-12 col-xs-12 col-md-4 col-lg-3">
        <div class="list-group">
            <a href="${pageContext.request.contextPath}/user/admin/addNews" class="list-group-item active">
    ...
    <div class="main-right col-sm-12 col-xs-12 col-md-8 col-lg-9">
        ...
        <div>
            <p>请输入新闻标题:</p>
            <input type="text" maxlength="60" id="title" required="required" class="form-control" placeholder="请输入新闻标题">
        </div><br>
        <div>
            <p>请输入责任编辑人姓名:</p>
            <input type="text" maxlength="8" id="author" required="required" class="form-control" placeholder="请输入责任编辑人姓名">
        </div><br>
        ...
        <div class="btn-group fright">
            <button id="submitBtn" data-loading-text="Loading..." autocomplete="off" type="button" class="btn btn-default" onclick="submitData()">发布</button>
        </div>
