    ...
    <div class="main-right col-sm-12 col-xs-12 col-md-8 col-lg-9">
        <form id= "uploadForm">
            <div style="margin-right: 300px;">
                ...
                <input type="text" id="title" name="title" required="required" class="form-control" placeholder="请输入新闻标题">
            </div><br>
           ...
           <%-- <p >选择文件： <input type="file" id="file" name="file" onchange="fileChange(this)"/></p>--%>
            ...
            <div class="btn-group fright" style="margin-right: 819px">
                <button type="button" class="btn btn-default" onclick="uploadFile()">发布</button>
            </div>
        </form>
        <br>
    </div>
...
<script type="text/javascript">
    function uploadFile() {
        ...
        swal({title: "确定发布吗?",
                ...
                function(){
                    $.ajax({
                        url:"${pageContext.request.contextPath}/user/admin/updateFile",
                        type:"POST",
                        data:form,
                        contentType:false,
                        processData:false,
        ...
        UE.ajax.request("${pageContext.request.contextPath}/user/admin/findFileById",
                {
                    ...
                    onsuccess:function(result){
                        ...
                        $("#fileTypeId").val(result.fileTypeId);
