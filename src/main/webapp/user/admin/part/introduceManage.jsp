		...
		<div class="main-right col-sm-12 col-xs-12 col-md-8 col-lg-9">
			...
			<div class="bs-example bs-example-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					...
					<li role="presentation" class="">
						<a href="#friLinkSet" role="tab" id="friLinkSet-tab" data-toggle="tab" aria-controls="friLinkSet" aria-expanded="false">介绍</a>
					</li>
					<li role="presentation" class="">
				...
				<div id="myTabContent" class="tab-content">
					<button type="button" class="btn btn-primary btn-sm topbtn" data-toggle="modal"
							data-target="#myModal1" onclick="window.location.href='${pageContext.request.contextPath}/user/admin/updateIntro'">修改</button>
