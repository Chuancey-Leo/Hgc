				...
				<div class="main-right col-sm-12 col-xs-12 col-md-8 col-lg-9">
					...
					<div class="bs-example bs-example-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							...
							<li role="presentation" class="">
								<a href="#strolPicSet" role="tab" id="strolPicSet-tab" data-toggle="tab" aria-controls="strolPicSet" aria-expanded="false">基建科</a>
							</li>
							<li role="presentation" class="">
						...
						<div id="myTabContent" class="tab-content">
							<button type="button" class="btn btn-primary btn-sm topbtn" data-toggle="modal"
									data-target="#myModal1" onclick="window.location.href='${pageContext.request.contextPath}/user/admin/updateBase'">修改</button>
