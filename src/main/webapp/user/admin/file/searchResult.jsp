						...
						<li role="presentation" class="">
							<form action="${pageContext.request.contextPath}/user/admin/searchFile" method="get" class="navbar-form navbar-left" style="margin-bottom: -7px;" role="search">
								<div class="form-group">
									<input maxlength="100" style="margin-top: -6px" type="text" required="required" name="content" class="form-control" placeholder="输入要搜索的内容..">
					...
					<div>
						...
						<table class="table" fitColumns="true" pagination="true" rownumbers="true" fit="true">
							...
							<c:forEach var="file" items="${fileList}">
								<tr>
									<td>${file.title}</td>
									<td>${file.releaseDateStr }</td>
									<td><button type="button" class="btn btn-default"
												onclick="window.location.href='${pageContext.request.contextPath}/user/admin/updateFile/${file.id}'">更改</button></td>
									<td><button type="button" class="btn btn-default"
												onclick="window.location.href='${pageContext.request.contextPath}/file/preview/${file.id}'">预览</button></td>
