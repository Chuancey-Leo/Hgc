	...
	<script type="text/javascript">
		function submitData(){
			...
			if(content==null || content==''){
				...
				$.post("${pageContext.request.contextPath}/user/admin/saveOffice",{'id':3,'content':content},function(result){
					if(result.success){
						sweetAlert("修改成功！");
						/*resetValue();*/
					}else{
...
<div class="main-wrap">
	...
	<div class="main-right col-sm-12 col-xs-12 col-md-8 col-lg-9">
		<h3>修改</h3>
		<button type="button" class="btn btn-default" style="position: relative;margin-left: 91%;margin-bottom: 12px" onclick="javascript:window.location.href='${pageContext.request.contextPath}/user/admin/land'">返回</button>
		<div>
...
<script type="text/javascript">
	...
	ue.addListener("ready",function(){
		UE.getEditor('editor').setContent('${land.content}');
	});
</script>
