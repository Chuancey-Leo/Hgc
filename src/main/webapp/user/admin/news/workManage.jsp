						...
						<div role="tabpanel" class="tab-pane fade" id="botColSet" aria-labelledby="botColSet-tab">
							...
							<table class="table" fitColumns="true" pagination="true" rownumbers="true"
								...
								<c:forEach var="work" items="${workList}">
									<tr>
										<td><c:out value="${work.title}" escapeXml="true"/></td>
										<td><c:out value="${work.author}" escapeXml="true"/></td>
										<td><fmt:formatDate value="${work.releaseDate }" type="date" pattern="yyyy-MM-dd HH:mm"/></td>
										<td><button type="button" class="btn btn-default" onclick="deleteData(${work.id})">删除</button></td>
										<td><button type="button" class="btn btn-default"
                                                    onclick="window.location.href='${pageContext.request.contextPath}/user/admin/updateNews/${work.id}'">更改</button></td>
										<td><button type="button" class="btn btn-default" onclick="toTop(${work.id})">置顶</button></td>
                                        <td><button type="button" class="btn btn-default" onclick="cancelTop(${work.id})">取消置顶</button></td>
										<td><button type="button" class="btn btn-default" onclick="window.location.href='${pageContext.request.contextPath}/news/${work.id}'">预览</button></td>
