				...
				<div class="bs-example bs-example-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="">
							<a href="#botColSet" id="botColSet-tab" role="tab" data-toggle="tab" aria-controls="botColSet" aria-expanded="false">普通资料</a>
						</li>
						<li role="presentation" class="">
							<a href="${pageContext.request.contextPath}/user/admin/learn">学习资料</a>
						</li>
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="botColSet" aria-labelledby="botColSet-tab">
							...
							<table class="table">
								...
								<tbody>
								<c:forEach var="general" items="${generalList}">
									<tr>
										<td><c:out value="${general.title}" escapeXml="true"/></td>
										<td><c:out value="${general.sourceSize}" escapeXml="true"/></td>
										<td><c:out value="${general.downHit}" escapeXml="true"/></td>
										<td><fmt:formatDate value="${general.releaseDate }" type="date" pattern="yyyy-MM-dd HH:mm"/></td>
										<td><button type="button" class="btn btn-default" onclick="deleteData(${general.id})">删除</button></td>
										<td><button type="button" class="btn btn-default"
													onclick="window.location.href='${pageContext.request.contextPath}/user/admin/updateFile/${general.id}'">更改</button></td>
										<td><button type="button" class="btn btn-default"
													onclick="window.location.href='${pageContext.request.contextPath}/source/preview/${general.id}'">预览</button></td>
									</tr>
								</c:forEach>
								</tbody>
							</table>
