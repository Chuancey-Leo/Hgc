						...
						<div>
							<table class="table">
								...
								<c:forEach var="source" items="${sourceList}">
									<tr>
										<td>${source.title}</td>
										<td><c:out value="${source.sourceSize}" escapeXml="true"/></td>
										<td>${source.releaseDateStr}</td>
										<td><button type="button" class="btn btn-default"
													onclick="window.location.href='${pageContext.request.contextPath}/user/admin/updateFile/${source.id}'">更改</button></td>
										<td><button type="button" class="btn btn-default"
													onclick="window.location.href='${pageContext.request.contextPath}/source/preview/${source.id}'">预览</button></td>
									</tr>
								</c:forEach>
								</tbody>
							</table>
