...
<script type="text/javascript">
	...
	function openLinkModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/user/admin/save.do?id="+row.id;
	 }
...
<table id="dg" title="博客类别管理" class="easyui-datagrid"
   ...
   url="${pageContext.request.contextPath}/user/admin/linkList" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="id" width="20" align="center">编号</th>
   		<th field="linkName" width="100" align="center">链接信息</th>
 ...
 <div id="dlg" class="easyui-dialog" style="width:500px;height:180px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		...
   		<tr>
   			<td>链接：</td>
   			<td><input type="text" id="link" name="link" class="easyui-numberbox" required="true" style="width: 60px"/></td>
   		</tr>
   	</table>
   </form>
 </div>
