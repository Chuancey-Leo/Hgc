...
<div class="container page-wrap">
    <div class="col-md-8 col-xs-12">
        <div class="list-wrap">
            <h3><i class="fa fa-list-alt"></i> 招标信息</h3>
            <div class="list-box">
                <ul class="newslist">
                    <c:forEach var="tender" items="${tenderList}">
                        <li><a href="${pageContext.request.contextPath}/news/${tender.id}"><i class="fa fa-chevron-circle-right"></i> &nbsp;&nbsp;&nbsp; <c:out value="${tender.title}" escapeXml="true"/></a>
                            <span><i class="fa fa-calendar"></i> <fmt:formatDate value="${tender.releaseDate }" type="date" pattern="MM-dd"/></span></li>
                    </c:forEach>
                </ul>
                <nav>
                    <ul class="pagination">
